      ...
      <div class="sm:flex sm:items-center">
        ...
        <div class="relative px-5 py-5 sm:py-0 sm:ml-4 sm:px-0">
          <div class="flex items-center sm:hidden">
            <img class="h-10 w-10 object-cover rounded-full border-2 border-gray-600" src="https://images.unsplash.com/photo-1598635239935-2d037ba3819c?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=256&q=80" alt="">
          ...
          <Dropdown class="hidden sm:block">
            <template #trigger="{ hasFocus, isOpen }">
              ...
              >
                <img class="h-full w-full object-cover" src="https://images.unsplash.com/photo-1598635239935-2d037ba3819c?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=256&q=80" alt="">
              </span>
            </template>
            <template #dropdown>
              <div class="mt-3 bg-white rounded-lg w-48 py-2 shadow-xl xl:border">
                <a href="#" class="block hover:text-white text-gray-800 px-4 py-2 hover:bg-indigo-500">Account Settings</a>
                <a href="#" class="block hover:text-white text-gray-800 mt-0 px-4 py-2 hover:bg-indigo-500">Support</a>
                <a href="#" class="block hover:text-white text-gray-800 mt-0 px-4 py-2 hover:bg-indigo-500">Sign out</a>
              </div>
            </template>
          </Dropdown>
        </div>
