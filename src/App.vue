  ...
  <div id="app" class="min-h-screen bg-gray-200 antialiased"> 
    ...
    <main class="py-6">
      <div class="px-4">  
        ...
        <p class="text-gray-600">Live like the stars in these luxurios Southern Carlifornia estates.</p>
      </div>
      <div class="mt-6 sm:overflow-x-auto">
        <div class="px-4 sm:inline-flex sm:-mx-2 sm:pb-8">
          <div v-for="(loop, index) in looper" :key="index" :class="{'mt-10': loop > 1}" class="sm:mt-0 sm:w-80 sm:flex-shrink-0 sm:px-2">
            <div class="relative pb-5/6">
              <img class="absolute inset-0 h-full rounded-lg shadow-md" src="https://images.unsplash.com/photo-1512917774080-9991f1c4c750?ixlib=rb-1.2.1&auto=format&fit=crop&w=1050&q=80" alt="mordern-house"> 
            </div>
            <div class="relative px-4 -mt-16">
              <div class="bg-white rounded-lg px-4 py-3 shadow-lg object-cover">
                ...
                <h4 class="mt-1 text-gray-900 font-semibold text-lg">Modern home in a city</h4>
                <div class="mt-1">
