<template>
  <div class="min-h-screen bg-gray-200 antialiased xl:flex xl:flex-col xl:h-screen"> 
    <SideHeader class="xl:flex-shrink-0"/>
      ...
      <main class="py-6 xl:flex-1 xl:overflow-x-hidden">
        ...
        <div class="mt-6 sm:overflow-x-auto">
          <div class="px-4 sm:inline-flex sm:-mx-2 sm:pb-8">
            <div v-for="(property, index) in properties" :key="index" :class="{'mt-10 sm:ml-4': index > 0}" class="sm:mt-0 sm:w-80 sm:flex-shrink-0 sm:px-2">
      ...
      properties: [
        {
          ...
          beds: 3,
          baths: 4,
          title: 'Modern hime in city cebter',
          price: 150000,
          reviewCount: 24,
          rating: 3
        },
