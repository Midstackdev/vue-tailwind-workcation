<template>
  <div class="px-8 py-12 bg-gray-100 max-w-xl mx-auto lg:max-w-full lg:px-0 lg:py-20 lg:relative lg:min-h-screen">
    ...
    <div class="lg:w-7/12 lg:pl-12 lg:pr-8">
      <svg class="h-10 w-auto" viewBox="0 0 185 32" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="mt-8 lg:mt-0 lg:absolute lg:inset-y-0 lg:right-0 lg:w-5/12">
          <img class="h-56 sm:h-56 w-full object-cover object-center rounded-lg shadow-xl lg:h-full lg:inset-0 lg:shadow-none lg:rounded-none lg:object-left" src="https://images.unsplash.com/photo-1525959526508-a37b4add7e70?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1050&q=80" alt="work-on-beach">
        ...
        <h1 class="mt-8 text-3xl sm:text-4xl font-bold text-gray-900 leading-tight lg:mt-12">
        ...
        <div class="mt-6">
          <a href="/dashboard" class="px-5 py-3 inline-block rounded-lg bg-indigo-500 hover:bg-indigo-700 text-white font-semibold tracking-wide uppercase shadow-lg">Book your escape</a>
        </div>
    </div>
    </div>
  </div>
